...
urls = ["http://xiaoyuan.zhaopin.com/full/0/0_0_0_0_0_-1_%E7%BB%9F%E8%AE%A1_{}_0".format(str(x)) for x in range(1, 3)]
...
cursor = db.cursor()
cursor.execute("DROP TABLE IF EXISTS zhilian_stats")
db.commit()
cursor.execute('''CREATE TABLE IF NOT EXISTS zhilian_stats(
